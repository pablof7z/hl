...
characterization: "OCR capture pipeline validation: build PASS, capture idle panel PASS, camera viewfinder PASS, shutter→OCR FAIL (CameraX 'No available camera'), barcode scanner PASS"
captured_at: 2026-06-13T18:05:51Z
---

OCR capture pipeline validation: build PASS, capture idle panel PASS, camera viewfinder PASS, shutter→OCR FAIL (CameraX 'No available camera'), barcode scanner PASS
