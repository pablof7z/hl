...
characterization: "OCR capture pipeline validation: build PASS, capture idle PASS, camera viewfinder PASS, shutter capture FAIL (CameraX no-camera error), barcode scanner PASS"
captured_at: 2026-06-13T18:36:51Z
---

OCR capture pipeline validation: build PASS, capture idle PASS, camera viewfinder PASS, shutter capture FAIL (CameraX no-camera error), barcode scanner PASS
