...
agent_attribution: Recover emulator + validate rooms
has_preregistered_criteria: true
has_method: true
has_structured_report: true
characterization: "Rooms re-validation: room tiles FAIL (hex IDs still showing), open room stays open PASS, no ANR this run"
captured_at: 2026-06-13T13:19:48Z
---

Rooms re-validation: room tiles FAIL (hex IDs still showing), open room stays open PASS, no ANR this run
