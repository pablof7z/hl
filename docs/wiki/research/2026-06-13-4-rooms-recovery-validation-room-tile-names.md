...
characterization: "Rooms recovery validation (room tile names, room stays open, ANR check) — verdict: FAIL for tile names, PASS for room stays open, NO ANR"
captured_at: 2026-06-13T13:03:20Z
---

Rooms recovery validation (room tile names, room stays open, ANR check) — verdict: FAIL for tile names, PASS for room stays open, NO ANR
