...
agent_attribution: ab6f0abe9caee7721
has_preregistered_criteria: true
has_method: true
has_structured_report: true
characterization: "OCR capture pipeline validation: capture idle PASS, camera viewfinder PASS, shutter→OCR FAIL (CameraX 'No available camera can be found'), barcode scanner PASS"
captured_at: 2026-06-13T17:51:25Z
---

OCR capture pipeline validation: capture idle PASS, camera viewfinder PASS, shutter→OCR FAIL (CameraX 'No available camera can be found'), barcode scanner PASS
