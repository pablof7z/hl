...
characterization: "Cold-boot OCR pipeline: camera PASS, shutter PASS, review screen FAIL (Compose infinite-height crash), root cause LazyColumn+verticalScroll nesting"
captured_at: 2026-06-14T08:38:43Z
---

Cold-boot OCR pipeline: camera PASS, shutter PASS, review screen FAIL (Compose infinite-height crash), root cause LazyColumn+verticalScroll nesting
