...
agent_attribution: ae3578303af966db3
has_preregistered_criteria: true
has_method: true
has_structured_report: true
characterization: "Re-validated Fix 3 room tile names FAIL (still showing hex), Fix 4 open room stays open PASS, ANR check: no ANR this run but 200+ frame skips persist"
captured_at: 2026-06-13T13:14:36Z
---

Re-validated Fix 3 room tile names FAIL (still showing hex), Fix 4 open room stays open PASS, ANR check: no ANR this run but 200+ frame skips persist
