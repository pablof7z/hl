...
actor SafeHighlighterCore {
    ...
    nonisolated func projectCapturePublishResult(
        input: CapturePublishResultProjectionInput
    ) -> CapturePublishResultProjection {
        core.projectCapturePublishResult(input: input)
    }
    ...
    nonisolated func projectFeedbackPublishResult(
    ...
    nonisolated func projectDiscussionPublishResult(
        input: DiscussionPublishResultInput
    ) -> DiscussionPublishResultProjection {
        core.projectDiscussionPublishResult(input: input)
    }
    ...
    nonisolated func projectCommentSnapshotApply(
    ...
    nonisolated func projectViewSubscriptionStart(
