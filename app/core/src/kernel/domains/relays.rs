...
pub(crate) fn run_effect_add_relay(url: String, role: String, nmp: Option<&NmpHandle>) {
    ...
    let _ = nmp_ref
        .actor_sender()
        .send(nmp_core::actor::ActorCommand::Relay(nmp_core::actor::RelayCommand::AddRelay { url, role }));
}
...
pub(crate) fn run_effect_remove_relay(url: String, nmp: Option<&NmpHandle>) {
    ...
    let _ = nmp_ref
        .actor_sender()
        .send(nmp_core::actor::ActorCommand::Relay(nmp_core::actor::RelayCommand::RemoveRelay { url }));
}
...
pub(crate) fn run_effect_publish_rooms_relay_list(content: String, nmp: Option<&NmpHandle>) {
    ...
    let _ = nmp_ref
        .actor_sender()
        .send(nmp_core::actor::ActorCommand::Publish(nmp_core::actor::PublishCommand::UnsignedEvent {
