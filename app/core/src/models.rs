...
// Phase 7 — Part-C prep: ArtifactPreview, Chapter, and ArtifactRecord were
// relocated into the kernel lane (`crate::kernel::models`) because the kernel
// uses them directly. Re-imported here so the ~24 bespoke files that reference
// `crate::models::{ArtifactRecord, ArtifactPreview, Chapter}` keep resolving.
pub use crate::kernel::models::{ArtifactPreview, ArtifactRecord, Chapter};
...
// Phase 7 — Part-C prep: relocated into the kernel lane
// (`crate::kernel::models`); re-imported here for the bespoke lane.
pub use crate::kernel::models::PodcastPositionRecord;
